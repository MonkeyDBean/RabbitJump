...
var GameController = (function () {
    function GameController() {
        ...
        this.MaxLevel = 10;
        //记录每层开始时间
        this.startTime_level = 0;
        //记录每层结束时间
        this.endTime_level = 0;
        //记录每层持续时间
        this.durationTime_level = 0;
    }
    ...
    GameController.prototype.preStartGame = function () {
    ...
    //每25ms执行一次处理
    GameController.prototype.addGameTimeListener = function () {
    ...
    GameController.prototype.changeTreePos = function () {
        for (var i = 0; i < 3; i++) {
    ...
    GameController.prototype.mapChange = function () {
        ...
        var GloPos = this.myPlayer.getGlobalPoint();
        ...
        this.myMap.addChild(this.myPlayer);
        var localPos = this.myPlayer.parent.globalToLocal(GloPos.x, GloPos.y);
    ...
    GameController.prototype.touchJump = function () {
        if (this.myPlayer.getJumpStage() == 0) {
            ...
            if (this.myPlayer.getPlayerState() == playState.state_slide) {
                ...
                else if (this.myPlayer.getPlayerDirX() == 1) {
                    this.myPlayer.x += 20;
                }
            }
            this.myPlayer.changeState(playState.state_jump);
        }
        else if (this.myPlayer.getJumpStage() == 1) {
            this.myPlayer.changeState(playState.state_twiceJump);
        }
    };
    //角色生命不为0，恢复游戏
    GameController.prototype.recoverGame = function () {
    ...
    GameController.prototype.removeGameEvent = function () {
        this.myTimer.stop();
    ...
    GameController.prototype.removeTouchEvent = function () {
        Main.euiLayer.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, this.touchJump, this);
    };
    GameController.prototype.recoverGameEvent = function () {
        this.addGameTimeListener();
        Main.euiLayer.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.touchJump, this);
    };
    /**
