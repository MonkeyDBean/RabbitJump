...
var Maps = (function (_super) {
    ...
    Maps.prototype.readCheckPoint = function () {
    ...
    Maps.prototype.readFinishPoint = function () {
    ...
    Maps.prototype.displayWinFlag = function () {
    ...
    Maps.prototype.readMap = function () {
        ...
        if (GameController.getInstance().curLevel <= GameController.getInstance().MaxLevel) {
            ...
            this.readWall();
            for (var i = 0; i < this.sceneHeight * 12; i++) {
                var curCellType = GameController.getInstance()._stageJson["CheckPoint" + GameController.getInstance().curLevel + "_Stage" + this.randomStage]["GridType"][i];
            ...
            for (var i = 0; i < this.sceneHeight * 12; i++) {
                var curCellType = GameController.getInstance()._stageJson["AllFinish"]["GridType"][i];
                this.mapCells[i] = new Cell(curCellType);
                this.mapCells[i].x = 50 * (i % 12) + this.mapCells[i].width / 2;
                this.mapCells[i].y = 50 * Math.floor(i / 12) + this.mapCells[i].height / 2;
                if (curCellType !== 0) {
    ...
    Maps.prototype.readWall = function () {
